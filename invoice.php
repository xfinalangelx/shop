        ...
        <div class="row">            
            <div class="col-md-6 offset-md-3">
                    ...
                    <tbody class=""> 
                            ...
                            if($getPro){
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="padding-top: 30px"><?php echo 'RM'.$result['price'];?></td>
                ...
                <table class="tbl table-striped">
                    ...
                    <tr>
                        <th class="text-right">SST(10%) :</th>
                        <td>
                            <?php
                            $sst = $sum * 0.1;
                            echo 'RM'.number_format((float)$sst, 2, '.', '');
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php                                
                            $total_sum = $sum + $sst;                                
                            echo 'RM'.number_format((float)$total_sum, 2, '.', '');;
                            ?>
                        </td>
                    </tr>
                     <tr>
