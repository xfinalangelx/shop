...
<div class="main">
    <div class="container">
        <div class="row">
          <div class="text-success font-weight-bold" style="font-size: 25px;">Your Order Details</div>
          <br>
                    ...
                    <tbody class=""> 
                            ...
                            if($getOrder){
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="padding-top: 30px"><?php echo 'RM'.number_format((float)$result['price'], 2, '.', '');?></td>
                                    ...
                                    <td style="padding-top: 30px"> <a href="?confirmId=<?php echo $result['orderId'];?>">Shipped</a></td>
